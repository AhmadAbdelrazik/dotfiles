...
hl.monitor({ output = "HDMI-A-1", mode = "1280x1024@75", position = "1536x0", scale = 1 })
...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("waybar & hyprpaper & swaync & swayosd-server")
...
hl.env("HYPRSHOT_DIR", "/home/abdelrazik/Pictures/Screenshots")
...
-- Switch workspaces / move windows to workspaces (1–10)
for i = 1, 10 do
...
-- Volume / brightness (with swayosd OSD)
hl.bind(
...
-- Assign apps to workspaces on launch
hl.window_rule({
	name = "browser",
...
hl.window_rule({
	name = "teams",
	match = { class = "^(brave-ompifgpmddkgmclendfeacglnodjjndh-Default)$" },
	workspace = 4,
})
...
-- Hyprland-run floating terminal positioning
hl.window_rule({
